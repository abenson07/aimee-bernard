...
export const SITE_NAME = "Aimee Bernard";
/** Fallback meta description for pages that don't set their own. */
export const SITE_DESCRIPTION = "The official website of Aimee Bernard.";
/** Canonical origin. Resolves canonical URLs, social images, and the sitemap. Update before first production deploy. */
export const SITE_URL = "https://aimeebernard.com";
